...
// void CShmQueueSingle::clear()
// {
//     pq->clear();
// }

// int CShmQueueSingle::full()
// {
//     return pq->full();
// }
// int CShmQueueSingle::empty()
// {
//     return pq->empty();
// }
// int CShmQueueSingle::pushmsg(StMsgBuffer *pmsg)
// {
//     sta.check("CShmQueueSingle.pushmsg");
//     return pq->push(pmsgbase, pmsg->buf);
// }
// int CShmQueueSingle::popmsg(StMsgBuffer *pmsg)
// {
//     return pq->pop(pmsgbase, pmsg->buf);
// }
// int CShmQueueSingle::popmsg_just()
// {
//     return pq->pop_just(pmsgbase);
// }
// int CShmQueueSingle::topmsg(StMsgBuffer *pmsg)
// {
